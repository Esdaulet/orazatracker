...
export function buildKadirMessage(): string {
  return (
    ...
    `Күн батқаннан бастап (16 наурыз кешкісін) мың айдан қайырлы ұлық түн басталады. Бұл мүмкіндікті жіберіп алмаңыз! 🤲\n\n` +
    `📲 *Oraza-мен бірге кешке дайындалыңыз:* \n` +
    `• Түнге арналған дұғалар мен зікірлер\n` +
    `• Құлшылық жоспарын құру\n` +
    `• Ізгі амалдарды белгілеп, үлкен сауапқа кенелу\n\n` +
    `💫 *Ниетіңіз түзу, дұғаңыз қабыл болсын. Бұл түн өміріңізге береке алып келсін! 🤍\n\n`
  );
}
